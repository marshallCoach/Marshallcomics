  ...
  return (
    <div style={{ maxWidth: 960, margin: "0 auto", padding: "20px 18px 60px" }}>
      ...
      <div style={{
        ...
        <div style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:"0.62rem", letterSpacing:"2px", color:"var(--muted)", marginBottom:10 }}>
        ...
        {importMsg && (
          <div style={{
            marginTop:10, padding:"7px 12px", borderRadius:5, fontSize:"0.82rem",
        ...
        <div style={{ marginTop:8, fontSize:"0.75rem", color:"var(--muted)", fontFamily:"'Crimson Pro',serif", fontStyle:"italic" }}>
          ...
          return (
            <div key={s.field} style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
                ...
                {/* Label */}
                <div style={{ flex: 1, fontSize: "0.9rem", fontWeight: 600, color: "var(--brown-light)" }}>
                  {s.label}
              ...
              {/* Sample value */}
              {s.sample && (
                <div style={{ marginTop: 5, fontSize: "0.75rem", color: "var(--muted)",
