...
const TERRIFICON_SIGNINGS = [
  { priority: "#1",   book: "Uncanny X-Men #141 & #142 (Days of Future Past)", box: "AT PRESSER", creator: "Chris Claremont (ALL 3 DAYS)", goal: "Highest-value Terrificon target owned", note: "Top priority over Wolverine #8 and every other Claremont book. Sent to Magic Pressing → CGC this session, NM raw, not signed, grade pending — confirm turnaround lands before Aug 7.", critical: true, jimlee: false, alreadySigned: false },
  { priority: "#2",   book: "Wolverine #8 (1982)",            box: "72", creator: "Chris Claremont (ALL 3 DAYS)",       goal: "Yellow SS 9.8 = $500+",                  note: "MUST STAY UNSIGNED. Press before con. Box 72 (Variants). Sequence: Claremont at Terrificon FIRST, Frank Miller at NYCC SECOND for the combo signature.", critical: true,  jimlee: false, alreadySigned: false },
  ...
  return (
    <div>
      ...
      <div style={{ background:"#0b0b18", borderBottom:"2px solid #d4a800", padding:"10px 20px",
        ...
        <div>
          <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"2px", color:"#d4a800" }}>
            🎪 TERRIFICON — AUG 7–9, 2026 · MOHEGAN SUN, CT
          </div>
          <div style={{ fontSize:"0.875rem", color:"rgba(255,255,255,0.5)", marginTop:1 }}>
          ...
          <div style={{ display:"flex", gap:12, marginLeft:"auto" }}>
            {[
              ...
              <div key={u.lbl} style={{ textAlign:"center" }}>
                <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"1.75rem", color:"#d4a800", lineHeight:1, minWidth:36, textAlign:"center" }}>
                  {String(u.val).padStart(2,"0")}
                </div>
                <div style={{ fontSize:"0.875rem", letterSpacing:"1.5px", color:"rgba(255,255,255,0.4)", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>{u.lbl}</div>
              </div>
            ))}
          </div>
        )}
      ...
      <div style={{ background:"#fef2f2", borderBottom:"2px solid #dc2626", padding:"10px 20px 12px", fontSize:"0.875rem", color:"#7f1d1d", lineHeight:1.8 }}>
        <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"1.5px", color:"#dc2626", marginBottom:4 }}>⚡ CRITICAL RULES — READ BEFORE PACKING</div>
      ...
      <div style={{ background:"#0b0b0b", borderBottom:"1px solid #222", display:"flex", paddingLeft:14 }}>
        {([
          ...
          <button key={id} className={`tab-btn${view===id?" active":""}`}
            style={{ fontSize:"0.875rem", color: view===id?"#fff":"rgba(255,255,255,0.5)", borderBottomColor: view===id?"var(--red)":"transparent" }}
      ...
      {view === "roi" && (
        <>
          ...
          <div style={{ background:"var(--surface2)", borderBottom:"1px solid var(--border)", padding:"10px 20px",
            ...
            {[
              ...
              <div key={s.lbl} style={{ textAlign:"center", flex:"0 0 auto" }}>
                ...
                {s.sub && <div style={{ fontSize:"0.875rem", color:"var(--muted2)" }}>{s.sub}</div>}
              </div>
            ))}
            ...
            <div style={{ marginLeft:"auto", display:"flex", gap:8, alignItems:"center", flexWrap:"wrap" }}>
              <button
                ...
                style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"1.5px",
          ...
          <div style={{ background:"#fffff8", borderBottom:"1px solid var(--border)", padding:"6px 20px",
            display:"flex", gap:16, flexWrap:"wrap", fontSize:"0.875rem", color:"var(--muted2)", alignItems:"center" }}>
            <span style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"1.5px", color:"var(--muted)" }}>TIER PRICING:</span>
            {[
            ...
            <table style={{ width:"100%", borderCollapse:"collapse", fontSize:"0.875rem" }}>
                ...
                <tr style={{ background:"var(--surface2)", borderBottom:"2px solid var(--border)" }}>
                  {([
                    ...
                    <th key={h}
                      ...
                      style={{ padding:"8px 10px", textAlign:"left", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",
                        fontSize:"0.875rem", letterSpacing:"1.5px", whiteSpace:"nowrap",
                  ...
                  return (
                    <tr key={b.priority} style={{
                      ...
                      <td style={{ padding:"8px 10px", minWidth:200 }}>
                        ...
                        {b.doNotPress && (
                          <span style={{ fontSize:"0.875rem", background:"#dc2626", color:"#fff", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",
                            letterSpacing:"1px", borderRadius:3, padding:"1px 6px", display:"inline-block", marginTop:2 }}>
                            🚫 DO NOT PRESS
                          </span>
                        )}
                        {b.alert && b.alert !== "DO NOT PRESS" && (
                          <span style={{ fontSize:"0.875rem", background:"#d97706", color:"#fff", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",
                            letterSpacing:"1px", borderRadius:3, padding:"1px 6px", display:"inline-block", marginTop:2, marginLeft:4 }}>
                            ⚠️ {b.alert}
                          </span>
                        )}
                        {b.terrificon && (
                          <span style={{ fontSize:"0.875rem", background:"#d4a800", color:"#000", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",
                            letterSpacing:"1px", borderRadius:3, padding:"1px 6px", display:"inline-block", marginTop:2, marginLeft:4 }}>
                            🎪 TF
                          </span>
                        )}
                      ...
                      <td style={{ padding:"8px 10px", minWidth:140 }}>
                        <span style={{ fontSize:"0.875rem", background:lb, color:lc, border:`1px solid ${lc}40`,
                          borderRadius:3, padding:"2px 7px", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"0.5px" }}>
                          {b.labelType}
                        </span>
                      </td>
                      <td style={{ padding:"8px 10px", textAlign:"center", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px" }}>
                        {b.doNotPress
                          ? <span style={{ color:"#dc2626", fontSize:"0.875rem" }}>$0</span>
                      ...
                      <td style={{ padding:"8px 10px", textAlign:"center", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px", fontWeight:700 }}>
                        ${b.totalCost}
                      </td>
                      ...
                      <td style={{ padding:"8px 10px", color:"var(--gold)", fontWeight:600, whiteSpace:"nowrap" }}>
                        ${b.projectedLow}
                        <span style={{ marginLeft:5, fontSize:"0.875rem", cursor:"help", color:"var(--muted2)", verticalAlign:"middle" }}
                          title={`Projected range: $${b.projectedLow}–$${b.projectedHigh}`}>ⓘ</span>
                      </td>
                      <td style={{ padding:"8px 10px", textAlign:"center", color:"#16a34a", fontWeight:700, whiteSpace:"nowrap", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem" }}>
                        {b.roiMultiple}
                      </td>
                      <td style={{ padding:"8px 10px", color:"var(--muted2)", fontSize:"0.875rem", maxWidth:200 }}>
                        {b.note}
                      </td>
                    </tr>
                  );
              ...
              <tfoot>
                <tr style={{ background:"var(--surface)", borderTop:"2px solid var(--border)", fontWeight:700 }}>
                  <td colSpan={4} style={{ padding:"10px 14px", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px", fontSize:"0.875rem" }}>
                    TOTAL — {displayBooks.length} BOOKS {tfFilter ? "(Terrificon filter active)" : ""}
                  </td>
                  <td style={{ padding:"10px 10px", textAlign:"center", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
                    ${displayBooks.reduce((s,b)=>s+b.pressedCost,0)}
                  </td>
                  <td style={{ padding:"10px 10px", textAlign:"center", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
                    ${displayBooks.reduce((s,b)=>s+b.cgcCost,0)}
                  </td>
                  <td style={{ padding:"10px 10px", textAlign:"center", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", color:"var(--red)" }}>
          ...
          <div style={{ padding:"16px 20px 40px", display:"flex", flexWrap:"wrap", gap:12 }}>
            {[
              ...
              <div key={l.label} style={{ flex:"1 1 220px", background:"var(--surface)", border:`1.5px solid ${l.color}40`, borderRadius:6, padding:"12px 14px" }}>
                <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"1.5px", color:l.color, marginBottom:4 }}>{l.label}</div>
                <div style={{ fontSize:"0.875rem", color:"var(--muted2)", lineHeight:1.5 }}>{l.desc}</div>
              </div>
            ))}
          </div>
        </>
          ...
          {([
            ...
            <div key={group.label}>
              <div style={{ padding:"10px 18px 6px", background:`${group.accent}0d`, borderBottom:`1px solid ${group.accent}30`, borderTop:"1px solid var(--border)" }}>
                <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"2px", color:group.accent }}>{group.label}</div>
                <div style={{ fontSize:"0.875rem", color:"var(--muted2)", marginTop:2 }}>{group.sublabel}</div>
              </div>
                  ...
                  return (
                    <div key={gi} className={`lcard${isOpen?" open":""}`}
                      ...
                      <div className="lcard-head">
                        <span style={{ fontSize:"0.875rem", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px",
                        ...
                        <span style={{ fontSize:"0.875rem", color:"var(--muted)", flexShrink:0 }}>Box {s.box}</span>
                        {s.jimlee    && <span style={{ fontSize:"0.875rem", background:"#d97706", color:"#fff", borderRadius:3, padding:"1px 6px", flexShrink:0, fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px" }}>SAT ONLY</span>}
                        {s.critical  && <span style={{ fontSize:"0.875rem", background:"#dc2626", color:"#fff", borderRadius:3, padding:"1px 6px", flexShrink:0, fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px" }}>🚫 UNSIGNED</span>}
                        {s.alreadySigned && <span style={{ fontSize:"0.875rem", background:"#2563eb", color:"#fff", borderRadius:3, padding:"1px 6px", flexShrink:0, fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px" }}>SIGNED</span>}
                      </div>
                      {!isOpen && <div style={{ fontSize:"0.875rem", color:"var(--muted2)", marginTop:3, paddingLeft:4 }}>{s.creator}</div>}
                      {isOpen && (
      ...
      {view === "press" && (
        <>
          <div style={{ background:"#fff8e0", borderBottom:"2px solid #d4a800", padding:"10px 20px", fontSize:"0.875rem", color:"#8a6000", lineHeight:1.7 }}>
            <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"2px", marginBottom:4 }}>
              ...
              <thead>
                <tr style={{ background:"var(--surface2)", borderBottom:"2px solid var(--border)" }}>
                  {["Book","Box","CGC Path","🗜️ Press","📋 CGC Submit","💰 Total","Projected Value"].map(h => (
                    <th key={h} style={{ padding:"8px 14px", textAlign:"left", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",
                      fontSize:"0.875rem", letterSpacing:"1.5px", color:"var(--muted)", whiteSpace:"nowrap" }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                  ...
                  return (
                    <tr key={p.priority} style={{ borderBottom:"1px solid var(--border)", background: i%2===0?"transparent":"var(--surface2)" }}>
                      ...
                      <td style={{ padding:"9px 14px" }}>
                        <span style={{ fontSize:"0.875rem", color:lc, fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"0.5px" }}>
                          {p.labelType}
                        </span>
                      </td>
                      <td style={{ padding:"9px 14px", textAlign:"center", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px" }}>${p.pressedCost}</td>
                      <td style={{ padding:"9px 14px", textAlign:"center", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px" }}>${p.cgcCost}</td>
                      <td style={{ padding:"9px 14px", textAlign:"center", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px", fontWeight:700 }}>${p.totalCost}</td>
                ...
                {CGC_BOOKS.filter(b => b.doNotPress).map(p => (
                  <tr key={p.priority} style={{ borderBottom:"1px solid var(--border)", background:"#fff0f0" }}>
                    <td style={{ padding:"9px 14px", fontWeight:600 }}>
                      {p.book}
                      <span style={{ fontSize:"0.875rem", background:"#16a34a", color:"#fff", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",
                        letterSpacing:"1px", borderRadius:3, padding:"1px 6px", marginLeft:6 }}>
                        {p.status === "AT CGC — SUBMITTED" ? "✅ AT CGC" : "🚫 DO NOT PRESS"}
                      </span>
                    </td>
                    <td style={{ padding:"9px 14px", color:"var(--muted)", textAlign:"center" }}>{p.box}</td>
                    <td style={{ padding:"9px 14px", fontSize:"0.875rem", color:"#16a34a" }}>
                      {p.status === "AT CGC — SUBMITTED" ? "Already submitted — tracking at cgccomics.com" : p.labelType}
                    </td>
                    <td style={{ padding:"9px 14px", textAlign:"center", color:"#dc2626", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>$0</td>
                    <td style={{ padding:"9px 14px", textAlign:"center", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>${p.cgcCost}</td>
                    <td style={{ padding:"9px 14px", textAlign:"center", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontWeight:700 }}>${p.totalCost}</td>
                    <td style={{ padding:"9px 14px", color:"var(--gold)", fontWeight:600 }}>${p.projectedLow}–${p.projectedHigh}</td>
                  </tr>
                ))}
                ...
                <tr style={{ borderTop:"2px solid var(--border)", background:"var(--surface)", fontWeight:700 }}>
                  <td colSpan={3} style={{ padding:"10px 14px", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px", fontSize:"0.875rem" }}>
                    TOTAL — {CGC_BOOKS.length} BOOKS
                  </td>
                  <td style={{ padding:"10px 14px", textAlign:"center", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
                    ${totalPressInvest}
                  </td>
                  <td style={{ padding:"10px 14px", textAlign:"center", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
                    ${totalCGCInvest}
                  </td>
                  <td style={{ padding:"10px 14px", textAlign:"center", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", color:"var(--red)", fontSize:"0.875rem" }}>
                    ${totalAllIn}
                  </td>
      ...
      {view === "nycc" && (
        <div style={{ padding:"40px 24px", textAlign:"center", color:"var(--muted2)" }}>
          ...
          <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"2px", color:"var(--text)", marginBottom:8 }}>NYCC — Oct 8–11, 2026 · Javits Center, NYC</div>
          <div style={{ fontSize:"0.875rem", lineHeight:1.8, maxWidth:520, margin:"0 auto" }}>
          ...
          <div style={{ marginTop:20, display:"inline-block", background:"var(--surface)", border:"1.5px solid var(--border)",
            ...
            <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"2px", color:"var(--red)", marginBottom:8 }}>NYCC CHECKLIST</div>
            {[
              ...
              <div key={i} style={{ fontSize:"0.875rem", color:"var(--muted2)", lineHeight:2, display:"flex", gap:8 }}>
