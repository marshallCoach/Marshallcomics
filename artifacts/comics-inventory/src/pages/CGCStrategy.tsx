...
const CGC_BOOKS: CgcBook[] = [
  ...
  { priority:20, tier:"medium",   book:"Immortal Iron Fist #1 (Brubaker/Aja)",                   box:34, labelType:"Blue Universal",                             pressedCost:20, cgcCost:53, totalCost:73,  rawNM:18,  projectedLow:80,  projectedHigh:150,  roiMultiple:"1.1x–2.1x", status:"Not Started", note:"Landmark Iron Fist relaunch." },
  ...
  { priority:23, tier:"medium",   book:"ASM #27 (Dan Slott SIGNED)",                             box:25, labelType:"Green Qualified (CGC × JSA)",                pressedCost:20, cgcCost:53, totalCost:73,  rawNM:10,  projectedLow:40,  projectedHigh:80,   roiMultiple:"0.5x–1.1x", status:"Not Started", note:"Newly found signed book. Dan Slott signature. CGC × JSA." },
];
