...
export default function ShowPlanner() {
  ...
  return (
    <div>
      ...
      <div style={{ background:"var(--surface2)", borderBottom:"1px solid var(--border)", padding:"10px 20px", fontSize:"0.82rem", color:"var(--muted2)" }}>
      ...
      <div style={{ margin:"24px 20px 40px", padding:"16px 20px", background:"var(--surface)", border:"1.5px solid var(--border)", borderRadius:8 }}>
        <div style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:"0.82rem", letterSpacing:"1.5px", color:"var(--red)", marginBottom:8 }}>
          WHATNOT SHOW STRATEGY PRINCIPLES
        </div>
        <div style={{ display:"flex", flexWrap:"wrap", gap:14, fontSize:"0.75rem", color:"var(--muted2)", lineHeight:1.6 }}>
          {[
            ...
            <div key={p.h} style={{ flex:"1 1 220px" }}>
              <div style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:"0.75rem", letterSpacing:"1px", color:"var(--text)", marginBottom:3 }}>{p.h}</div>
              <div>{p.t}</div>
            </div>
          ))}
        </div>
