...
export const NEXT_STEPS = [
  ...
  { urgency:"critical", deadline:"This week",    title:"Book Terrificon Hotel — Hyatt code G-TRFC",                                detail:"Hyatt Regency Mohegan Sun, Uncasville CT. Code G-TRFC. Jim Lee is SATURDAY AUG 8 ONLY. This fills up fast — book immediately. Protects the entire Terrificon strategy.",                                                                               category:"Show"    },
  { urgency:"critical", deadline:"This week",    title:"Bag DC New 52 boxes (Box 44 + Box 48) — ALL UNBAGGED",                    detail:"Superman Unchained #1 and Batman Europa #1 are Jim Lee Terrificon targets. Both currently unbagged. CGC will not accept unbagged books. Bag every book in Box 44 (DC New 52 Batgirl/BW/NW) and Box 48 (DC Rebirth Core) — keys in mylar, runs in poly.",  category:"Bagging" },
  { urgency:"critical", deadline:"This week",    title:"Identify new signed WildCATs — which issue, who signed?",                 detail:"New WildCATs purchase — who signed it and which issue? One-sentence reply updates the entire CGC × JSA submission queue. Needed to determine if it goes in the Green Qualified batch or a separate submission.",                                           category:"Signing" },
  { urgency:"high",     deadline:"Jun 5 ⚠️",    title:"Jorge Jiménez CGC SS — Batman #125 — DEADLINE IMMINENT",                  detail:"Batman #125 (Failsafe arc — Jiménez drew it). Deadline may have passed — confirm submitted immediately. Pull from Box 43 (DC Rebirth). Press first, then CGC Modern Tier.",                                                                         category:"Signing" },
  { urgency:"high",     deadline:"Jun 2026",     title:"Hunt New Mutants #98 — first Deadpool",                                   detail:"Box 35 (Exiles + GenX) has NM #93 and #97. #98 is the first Deadpool appearance. Check Box 35 first — physical proximity makes it near-certain. Also check Boxes 2–3 (X-Men). Raw NM value: $800+.",                                              category:"Inventory"},
  { urgency:"high",     deadline:"Jun 2026",     title:"Press + submit Batman #656 & #657 — 1st Damian Wayne",                    detail:"Best single-book ROI after Stan Lee. Press first (CGC's own pressing service or Crushing Comics), then CGC Modern tier. $73 in fees per book = $350–500 out. Combined CGC 9.8 value: $550–900 on a $200 raw investment. Both in Box 1.",           category:"CGC"     },
  { urgency:"high",     deadline:"Jul 10",       title:"Roy Thomas — 5 books SUBMITTED — confirm receipt",                       detail:"Avengers #60, #87, King-Size #2, Marvel Premiere #1, Saga Human Torch #3 — already submitted. Confirm CGC received the package. Expected return $820–1,630 on $485 investment. Roy Thomas co-created Wolverine, Vision, Carol Danvers.",       category:"Signing" },
  { urgency:"high",     deadline:"Jun 26",       title:"Geoff Johns + Jason Fabok CGC SS — JL #21 + JSA run",                    detail:"Justice League #21 + JSA run books. Submit NOW before Jun 26 deadline. Pull from Box 46 (DC Earth 2 + JL New 52). Johns sig adds to existing unwitnessed sigs = yellow/green combo label.",                                                       category:"Signing" },
  { urgency:"high",     deadline:"Before Aug 7", title:"GREEN QUALIFIED BATCH — press and submit all together",                   detail:"Press: Vision #1, Black Lightning #1, New Warriors #1, WildCATs #3, Savage Dragon #1, Thor #339, MOS #18/19, Mockingbird #8, NM #96, Transformers #1, Cap Carter, Agent Carter, Hawkeye Freefall #1. Submit all to CGC × JSA in one batch. Cost: $15–25/book press.",  category:"CGC"     },
  { urgency:"high",     deadline:"Aug 7",        title:"Terrificon — Wolverine #8 — KEEP UNSIGNED — Claremont Yellow SS",        detail:"Box 72 (Variants). This is your Priority #1 Terrificon target. Chris Claremont is confirmed all 3 days. Yellow SS 9.8 = $500+ vs $80 raw. DO NOT sign this book before August 7. DO NOT bring already-signed books for Yellow SS.",                  category:"Show"    },
  { urgency:"high",     deadline:"Aug 7",        title:"Terrificon — Moon Knight Vol 6 #1-6 — Declan Shalvey Yellow SS ×6",      detail:"Box 33 (Moon Knight). Pull all 6 issues. Shalvey is confirmed and he DREW these books. Six Yellow SS signings = up to $1,200 in authenticated value from books currently worth $25 raw each.",                                                          category:"Show"    },
  { urgency:"high",     deadline:"Aug 8 10am",   title:"Terrificon — Jim Lee SATURDAY ONLY — arrive 10am sharp",                 detail:"Jim Lee is SATURDAY AUG 8 ONLY. Arrive 10am. Targets: Superman Unchained #1 + Batman Europa #1 (both in Box 44 — bag them first). Flash #164 → Mark Waid + LaRocque (both confirmed) dual Yellow SS. X-Men Legends #4 → Walt + Louise Simonson.",  category:"Show"    },
  { urgency:"medium",   deadline:"Jul 10",       title:"Mike Mayhew CGC SS — ASM #50 Alex Ross Timeless Virgin",                 detail:"Already signed — submit via CGC × JSA Green Qualified path. $100–200 authenticated. Same deadline as Roy Thomas batch. Pull from Box 16 (Spider-Man Archive).",                                                                                    category:"Signing" },
  { urgency:"medium",   deadline:"Oct 8–11",     title:"NYCC 2026 — Heritage networking + dealer floor buy",                     detail:"Stan Lee BP #513: already handled via CGC × JSA — no NYCC action needed. Bring Thor #169 CGC 8.0 (slabbed) for Heritage dealer evaluation. Buy budget: $100–300 for undervalued keys on the dealer floor. Post-NYCC haul show Oct 14 is your highest-engagement Whatnot show of Q4.", category:"Show" },
  { urgency:"low",      deadline:"Ongoing",      title:"eBay passive listings — reader/poor condition issues",                    detail:"Flash Vol 2 #112–125 (low grade), ASM #583 (water damage), non-key run issues, duplicates, UK sticker variants. Start at $1–3 each or bundle lots. Right buyer finds it — no story needed.",                                                          category:"Sales"   },
];
