...
export default function PasswordGate({ children }: Props) {
  ...
  if (stage === "registering" || stage === "authing") {
    return (
      <div style={{ minHeight:"100vh", background:"#111", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:20 }}>
        ...
        <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"3px", color:"rgba(255,255,255,0.5)" }}>
  ...
  if (stage === "offer-faceid") {
    return (
      <div style={{ minHeight:"100vh", background:"#111", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:24 }}>
        ...
        <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"1.75rem", letterSpacing:"5px", color:"#c8102e", marginBottom:8 }}>Use {bio.name}?</div>
        <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", color:"rgba(255,255,255,0.55)", textAlign:"center", maxWidth:300, lineHeight:1.6, marginBottom:32 }}>
          Skip the password next time — just use your {bio.verb} to unlock on this device.
        </div>
        <div style={{ display:"flex", flexDirection:"column", gap:12, width:"100%", maxWidth:300 }}>
          <button
            onClick={setupBiometric}
            style={{ background:"#c8102e", color:"#fff", border:"none", borderRadius:8, padding:"14px", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"2.5px", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", gap:10 }}>
            <BiometricIcon type={bio.icon} size={22} color="#fff" />
            SET UP {bio.name.toUpperCase()}
          </button>
          <button
            onClick={() => setUnlocked(true)}
            style={{ background:"transparent", color:"rgba(255,255,255,0.35)", border:"1.5px solid #333", borderRadius:8, padding:"12px", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"2px", cursor:"pointer" }}>
            SKIP — USE PASSWORD
          </button>
        </div>
        {biometricErr && (
          <div style={{ marginTop:20, color:"#f4a107", fontSize:"0.875rem", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", textAlign:"center", maxWidth:300 }}>{biometricErr}</div>
        )}
      </div>
    );
  }
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#111", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:24 }}>
      ...
      <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"1.75rem", letterSpacing:"6px", color:"#c8102e", marginBottom:4 }}>
        Marshall Comics
      </div>
      <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"3px", color:"rgba(255,255,255,0.35)", marginBottom:28, textTransform:"uppercase" }}>
      ...
      {!progressHidden && (
        <div style={{ width:"100%", maxWidth:340, marginBottom:28, position:"relative" }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"baseline", marginBottom:6 }}>
            <span style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"2.5px", color:"rgba(255,255,255,0.25)", textTransform:"uppercase" }}>Box Collection Progress</span>
            <div style={{ display:"flex", alignItems:"center", gap:8 }}>
              <span style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"1px", color:"#c8102e" }}>{_boxes} / {TARGET_BOXES} Boxes</span>
              <button
                onClick={() => { sessionStorage.setItem(PROGRESS_KEY, "1"); setProgressHidden(true); }}
                style={{ background:"none", border:"none", cursor:"pointer", color:"rgba(255,255,255,0.2)", fontSize:"0.875rem", padding:"0 2px", lineHeight:1, fontFamily:"sans-serif" }}
                title="Dismiss"
              >✕</button>
            </div>
          </div>
          ...
          <div style={{ display:"flex", justifyContent:"space-between", marginTop:6 }}>
            <span style={{ fontSize:"0.875rem", color:"rgba(255,255,255,0.18)", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px" }}>
              {_comics.length.toLocaleString()} Comics · {_keys.toLocaleString()} Keys · {_signed} Signed
            </span>
            <span style={{ fontSize:"0.875rem", color:"rgba(255,255,255,0.25)", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px" }}>
        ...
        <div style={{ width:"100%", maxWidth:340, marginBottom:16, display:"flex", flexDirection:"column", gap:8 }}>
          ...
          >
            ...
            <div style={{ textAlign:"left" }}>
              <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"2px", color:"#fff" }}>UNLOCK WITH {bio.name.toUpperCase()}</div>
              <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", color:"rgba(255,255,255,0.4)", marginTop:2 }}>Touch to authenticate</div>
            </div>
          </button>
          {biometricErr && (
            <div style={{ color:"#f4a107", fontSize:"0.875rem", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", textAlign:"center", padding:"6px 0" }}>{biometricErr}</div>
          )}
          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
            <div style={{ flex:1, height:1, background:"rgba(255,255,255,0.08)" }} />
            <span style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"2px", color:"rgba(255,255,255,0.2)" }}>OR</span>
            <div style={{ flex:1, height:1, background:"rgba(255,255,255,0.08)" }} />
          </div>
        </div>
      )}
      ...
      <div style={{ background:"#1c1c1c", border:"1.5px solid #333", borderRadius:10, padding:"32px 36px", width:"100%", maxWidth:340, display:"flex", flexDirection:"column", gap:16, animation: shake ? "shake 0.5s ease" : "none" }}>
        <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"2px", color:"rgba(255,255,255,0.4)", textAlign:"center", marginBottom:4 }}>
          Enter Password
        </div>
        <form onSubmit={e => { e.preventDefault(); attempt(); }} style={{ display:"contents" }}>
          <div style={{ position:"relative" }}>
            <input
              ...
              placeholder="••••••••••••••"
              autoFocus={!passkey}
              style={{ width:"100%", padding:"12px 40px 12px 14px", background:"#111", border:"1.5px solid #333", borderRadius:6, color:"#fff", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", outline:"none", letterSpacing:"2px", transition:"border-color 0.15s" }}
              onFocus={e => (e.target.style.borderColor = "#c8102e")}
              onBlur={e => (e.target.style.borderColor = "#333")}
            />
            <button type="button" onClick={() => setShow(s => !s)}
              style={{ position:"absolute", right:10, top:"50%", transform:"translateY(-50%)", background:"none", border:"none", cursor:"pointer", color:"rgba(255,255,255,0.35)", fontSize:"0.875rem", padding:4 }}>
              {show ? "HIDE" : "SHOW"}
            </button>
          </div>
          <button type="submit"
            style={{ background:"#c8102e", color:"#fff", border:"none", borderRadius:6, padding:"12px", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"2.5px", cursor:"pointer", transition:"background 0.15s" }}
      ...
      {passkey && (
        <button onClick={removeBiometric}
          style={{ marginTop:14, background:"none", border:"none", cursor:"pointer", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"2px", color:"rgba(255,255,255,0.15)", textDecoration:"underline" }}>
      ...
      <div style={{ marginTop:28, textAlign:"center" }}>
        <div style={{ fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", fontSize:"0.875rem", letterSpacing:"2.5px", color:"rgba(255,255,255,0.25)", marginBottom:12, textTransform:"uppercase" }}>
          Can't log in? Go here:
        </div>
        <div style={{ display:"flex", gap:10, justifyContent:"center", flexWrap:"wrap" }}>
          <a href="https://www.instagram.com/blackreadbrown" target="_blank" rel="noopener noreferrer"
            style={{ display:"flex", alignItems:"center", gap:5, color:"#e1306c", textDecoration:"none", fontSize:"0.875rem", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px", padding:"5px 12px", border:"1px solid #e1306c40", borderRadius:4, background:"#e1306c0f" }}>
          ...
          <a href="https://www.whatnot.com/user/blackreadbrown" target="_blank" rel="noopener noreferrer"
            style={{ display:"flex", alignItems:"center", gap:5, color:"#7c3aed", textDecoration:"none", fontSize:"0.875rem", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px", padding:"5px 12px", border:"1px solid #7c3aed40", borderRadius:4, background:"#7c3aed0f" }}>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://www.ebay.com/usr/blackreadbrown" target="_blank" rel="noopener noreferrer"
            style={{ display:"flex", alignItems:"center", gap:5, color:"#e43137", textDecoration:"none", fontSize:"0.875rem", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", letterSpacing:"1px", padding:"5px 12px", border:"1px solid #e4313740", borderRadius:4, background:"#e431370f" }}>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
