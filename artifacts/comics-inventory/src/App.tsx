...
export default function App() {
  ...
  return (
    ...
    <div style={{ minHeight:"100vh" }}>
      ...
      <header className="app-header">
        ...
        <div style={{ display:"flex", flexDirection:"column", alignItems:"flex-end", gap:10 }}>
          <div className="header-stats">
            ...
            <div className="stat"><span className="stat-val">{keys}</span><span className="stat-lbl">Keys</span></div>
          ...
          <div style={{ display:"flex", gap:10, alignItems:"center" }}>
            <a href="https://www.instagram.com/blackreadbrown" target="_blank" rel="noopener noreferrer"
              style={{ display:"flex", alignItems:"center", gap:5, color:"#e1306c", textDecoration:"none", fontSize:"0.72rem", fontFamily:"'Bebas Neue',sans-serif", letterSpacing:"1px", padding:"4px 10px", border:"1px solid #e1306c40", borderRadius:4, background:"#e1306c10" }}>
            ...
            <a href="https://www.whatnot.com/user/blackreadbrown" target="_blank" rel="noopener noreferrer"
              style={{ display:"flex", alignItems:"center", gap:5, color:"#7c3aed", textDecoration:"none", fontSize:"0.72rem", fontFamily:"'Bebas Neue',sans-serif", letterSpacing:"1px", padding:"4px 10px", border:"1px solid #7c3aed40", borderRadius:4, background:"#7c3aed10" }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.5 8.5l-7 9-3.5-4.5 1.5-1.167L10.5 14l5.5-7L17.5 8.5z"/></svg>
              Whatnot
            </a>
            <a href="https://www.ebay.com/usr/blackreadbrown" target="_blank" rel="noopener noreferrer"
              style={{ display:"flex", alignItems:"center", gap:5, color:"#e43137", textDecoration:"none", fontSize:"0.72rem", fontFamily:"'Bebas Neue',sans-serif", letterSpacing:"1px", padding:"4px 10px", border:"1px solid #e4313740", borderRadius:4, background:"#e4313710" }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M0 16.8v-1.6C0 9 5.4 5.6 10.8 5.6c2.4 0 4.8.8 6.4 2.4L16 9.2c-1.2-1.2-3.2-2-5.2-2C6.8 7.2 1.6 10 1.6 15.2v1.6c0 5.2 5.2 8 9.2 8 2 0 4-.8 5.2-2l1.2 1.2c-1.6 1.6-4 2.4-6.4 2.4C5.4 26.4 0 23 0 16.8zm13.6-3.2h8.8c-.4-3.2-2.8-5.6-6-5.6-2.8 0-5.2 2-6 5.6h3.2z"/></svg>
              eBay
            </a>
          </div>
        </div>
      ...
      {activeTab === "everything"  && <Everything  initBox={navParams.box} />}
