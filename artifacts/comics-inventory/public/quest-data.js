// AUTO-GENERATED quest data — source: comics_inventory_1507_2045_GCD_FILLED.xlsx (10917 rows) · generated 2026-07-16
// Regenerate with: node gen_quest_data.mjs
window.QUEST_DATA = {
 "source": "comics_inventory_1507_2045_GCD_FILLED.xlsx",
 ...
 "guide": [
  ...
  },
  {
   ...
   "accent": "green",
   "blurb": "Rows that are exact copies of another row: same book, same box, logged twice. Live count: 78 clone groups / 80 excess rows. Highest confidence, lowest effort, biggest visible progress.",
   "sittings": [
    {
     "id": "A1",
