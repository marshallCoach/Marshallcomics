...
const wb = XLSX.readFile('attached_assets/comics_inventory_1779453013446.xlsx');
...
// Source: comics_inventory_1779453013446.xlsx  |  Generated: ${new Date().toISOString().slice(0,10)}
